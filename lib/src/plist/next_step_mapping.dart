...
// Maps NeXTSTEP encoding byte (0x80..0xFF) to Unicode codepoint.
// Used to decode \NNN octal escapes in ASCII plist quoted strings.

// ignore_for_file: constant_identifier_names

const Map<int, int> nextStepMapping = {
